...
public class Woorden {
    ...
    public void setWoordamz(String woordamz) { this.woordamz = woordamz; }
    public String getWoordid() { return woordid; }
    public void setWoordid(String woordid) { this.woordid = woordid; }
    public String getWoordned() { return woordned; }
    public void setWoordned(String woordned) { this.woordned = woordned; }
